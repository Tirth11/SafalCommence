...
export const BUYERS: Buyer[] = [
  { id: 'BUY-88201', name: 'Rohit Sharma', email: 'rohit.sharma@example.com', phone: '+91 98765 43210', orders: 24, spend: 1100, registered: '18 Jan 2026', status: 'Active', city: 'Mumbai' },
  { id: 'BUY-88394', name: 'Ananya Gupta', email: 'ananya.g@example.com', phone: '+91 91234 56780', orders: 11, spend: 410, registered: '02 Mar 2026', status: 'Active', city: 'Gurugram' },
  { id: 'BUY-88512', name: 'Imran Sheikh', email: 'imran.sheikh@example.com', phone: '+91 99880 11223', orders: 6, spend: 190, registered: '21 Apr 2026', status: 'Suspended', city: 'Hyderabad' },
  { id: 'BUY-88677', name: 'Lakshmi Menon', email: 'lakshmi.m@example.com', phone: '+91 90876 55412', orders: 38, spend: 2000, registered: '09 Dec 2025', status: 'Active', city: 'Kochi' },
  { id: 'BUY-88910', name: 'Dev Patel', email: 'dev.patel@example.com', phone: '+91 97000 33445', orders: 2, spend: 69, registered: '05 Aug 2026', status: 'Active', city: 'Surat' },
  { id: 'BUY-89004', name: 'Nikita Bose', email: 'nikita.bose@example.com', phone: '+91 88990 76543', orders: 15, spend: 600, registered: '14 Feb 2026', status: 'Active', city: 'Kolkata' },
]
    ...
    subOrders: [
      {
        ...
        seller: 'TechWorld',
        sellerId: 'SLR-10021',
        items: [{ name: 'Wireless Noise Cancelling Headphones', sku: 'SP-WH-102-BLK', qty: 1, price: 69 }],
        value: 69,
        commission: 7,
        receivable: 62,
        fulfilment: 'Packed',
      ...
      },
      {
        ...
        seller: 'Urban Threads',
        sellerId: 'SLR-10248',
        items: [{ name: 'Premium Cotton Oversized Shirt', sku: 'UT-SH-44-M', qty: 2, price: 16 }],
        value: 32,
        commission: 3,
        receivable: 29,
        fulfilment: 'Processing',
      },
      {
        ...
        sellerId: 'SLR-10251',
        items: [{ name: 'Ceramic Table Lamp with Linen Shade', sku: 'LC-LMP-07', qty: 1, price: 31 }],
        value: 31,
        commission: 3,
        receivable: 28,
    ...
    subOrders: [
      {
        ...
        seller: 'GadgetHub Retail',
        sellerId: 'SLR-10260',
        items: [{ name: 'Titanium Smartwatch — Series 4', sku: 'KA-SW-04-TI', qty: 1, price: 120 }],
        value: 120,
        commission: 12,
        receivable: 108,
        fulfilment: 'Shipped',
    ...
    subOrders: [
      {
        ...
        seller: 'TechWorld',
        sellerId: 'SLR-10021',
        items: [{ name: 'Wireless Noise Cancelling Headphones', sku: 'SP-WH-102-WHT', qty: 1, price: 69 }],
        value: 69,
        commission: 7,
        receivable: 62,
        fulfilment: 'Cancelled',
    ...
    subOrders: [
      {
        ...
        seller: 'FitZone Sports',
        sellerId: 'SLR-10190',
        items: [{ name: 'Adjustable Dumbbell Set — 20 kg', sku: 'IC-DB-020', qty: 1, price: 79 }],
        value: 79,
        commission: 8,
        receivable: 71,
        fulfilment: 'Delivered',
      ...
      },
      {
        ...
        seller: 'GlowKart',
        sellerId: 'SLR-10102',
        items: [{ name: 'Vitamin C Brightening Face Serum', sku: 'AU-SR-055', qty: 1, price: 14 }],
        value: 14,
        commission: 1,
        receivable: 13,
        fulfilment: 'Delivered',
...
export const TRANSACTIONS: Transaction[] = [
  { id: 'TXN-556201', order: 'SH-100482', buyer: 'Rohit Sharma', gateway: 'Razorpay', method: 'UPI', amount: 150, date: '11 Aug 2026, 10:24', status: 'Successful', ref: 'pay_QF82nKd91Lm4Zx' },
  { id: 'TXN-556198', order: 'SH-100481', buyer: 'Ananya Gupta', gateway: 'Razorpay', method: 'Credit Card', amount: 120, date: '11 Aug 2026, 09:12', status: 'Successful', ref: 'pay_QF7yTb44Rm0Kq2' },
  { id: 'TXN-556190', order: 'SH-100476', buyer: 'Dev Patel', gateway: 'Razorpay', method: 'UPI', amount: 69, date: '10 Aug 2026, 14:02', status: 'Failed', ref: 'pay_QF5kJj71Bn29Pl', failureReason: 'Payment declined by customer bank', gatewayMessage: 'BAD_REQUEST_ERROR: payment failed because of insufficient funds' },
  { id: 'TXN-556186', order: 'SH-100479', buyer: 'Lakshmi Menon', gateway: 'Razorpay', method: 'Netbanking', amount: 31, date: '10 Aug 2026, 18:40', status: 'Refunded', ref: 'pay_QF6mLp02Xd77Vc' },
  { id: 'TXN-556180', order: 'SH-100470', buyer: 'Nikita Bose', gateway: 'Razorpay', method: 'UPI', amount: 94, date: '09 Aug 2026, 11:55', status: 'Successful', ref: 'pay_QF3nQw55Tt18Hs' },
  { id: 'TXN-556172', order: 'SH-100465', buyer: 'Imran Sheikh', gateway: 'Razorpay', method: 'Credit Card', amount: 41, date: '09 Aug 2026, 08:31', status: 'Pending', ref: 'pay_QF2bXr88Yy44Nn' },
  { id: 'TXN-556165', order: 'SH-100461', buyer: 'Ananya Gupta', gateway: 'Razorpay', method: 'UPI', amount: 24, date: '08 Aug 2026, 20:14', status: 'Partially Refunded', ref: 'pay_QF1cVv22Zz09Mm' },
]
...
export const REFUNDS: Refund[] = [
  { id: 'REF-3301', order: 'SH-100479', buyer: 'Lakshmi Menon', seller: 'HomeCraft Studio', amount: 31, orderValue: 31, reason: 'Product damaged on arrival', requested: '10 Aug 2026', status: 'Refunded', sellerComment: 'Damage confirmed from unboxing images. Refund agreed.' },
  { id: 'REF-3308', order: 'SH-100461', buyer: 'Ananya Gupta', seller: 'GlowKart', amount: 10, orderValue: 24, reason: 'Partial order missing — 1 of 2 items not delivered', requested: '11 Aug 2026', status: 'Under Review', sellerComment: 'Checking pickup manifest with courier.' },
  { id: 'REF-3311', order: 'SH-100470', buyer: 'Nikita Bose', seller: 'FitZone Sports', amount: 79, orderValue: 94, reason: 'Item not as described', requested: '11 Aug 2026', status: 'Requested' },
  { id: 'REF-3295', order: 'SH-100442', buyer: 'Rohit Sharma', seller: 'TechWorld', amount: 69, orderValue: 69, reason: 'Changed mind after delivery', requested: '07 Aug 2026', status: 'Rejected', sellerComment: 'Return window closed — request received on day 9.' },
]
...
export const SETTLEMENTS: Settlement[] = [
  { id: 'SET-10001', seller: 'ABC Electronics', sellerId: 'SLR-10021', period: '1 Aug – 7 Aug 2026', gross: 1200, refunds: 62, commission: 120, deductions: 12, net: 1006, status: 'Eligible', orders: 62 },
  { id: 'SET-10002', seller: 'Urban Threads', sellerId: 'SLR-10248', period: '1 Aug – 7 Aug 2026', gross: 580, refunds: 15, commission: 58, deductions: 5, net: 502, status: 'Eligible', orders: 31 },
  { id: 'SET-10003', seller: 'FitZone Sports', sellerId: 'SLR-10190', period: '1 Aug – 7 Aug 2026', gross: 980, refunds: 120, commission: 98, deductions: 8, net: 754, status: 'On Hold', holdReason: 'Return investigation — 9 returns flagged in 14 days.', orders: 44 },
  { id: 'SET-09988', seller: 'HomeCraft Studio', sellerId: 'SLR-10251', period: '25 Jul – 31 Jul 2026', gross: 400, refunds: 31, commission: 40, deductions: 3, net: 326, status: 'Paid', date: '04 Aug 2026', reference: 'HDFC/NEFT/882910', orders: 18 },
  { id: 'SET-09990', seller: 'GadgetHub Retail', sellerId: 'SLR-10260', period: '25 Jul – 31 Jul 2026', gross: 270, refunds: 1, commission: 27, deductions: 1, net: 241, status: 'Processing', orders: 12 },
  { id: 'SET-10005', seller: 'GlowKart', sellerId: 'SLR-10102', period: '8 Aug – 14 Aug 2026', gross: 190, refunds: 14, commission: 19, deductions: 1, net: 156, status: 'Pending', orders: 9 },
]
...
export const TICKETS: Ticket[] = [
  ...
  { id: 'TKT-7698', user: 'Dev Patel', userType: 'Buyer', order: 'SH-100476', subject: 'Payment failed but amount debited', description: 'UPI shows debit of $69but order marked failed.', priority: 'Urgent', status: 'Open', created: '10 Aug 2026' },
...
export const AUDIT_LOG: AuditEntry[] = [
  ...
  { id: 'AUD-99091', admin: 'Tirth Thaker', role: 'Super Admin', action: 'Refund Approved', module: 'Payments', target: 'REF-3301 · $31', oldValue: 'Under Review', newValue: 'Approved', reason: 'Damage confirmed from unboxing images', ip: '103.21.58.14', at: '10 Aug 2026, 13:47' },
...
export const SALES_TREND = [
  { day: '05 Aug', gross: 3600, net: 3400, commission: 340 },
  { day: '06 Aug', gross: 3900, net: 3600, commission: 360 },
  { day: '07 Aug', gross: 3700, net: 3500, commission: 350 },
  { day: '08 Aug', gross: 4400, net: 4200, commission: 420 },
  { day: '09 Aug', gross: 4800, net: 4500, commission: 450 },
  { day: '10 Aug', gross: 5200, net: 4800, commission: 480 },
  { day: '11 Aug', gross: 5600, net: 5200, commission: 520 },
]
...
export const ADMIN_NOTIFICATIONS: AdminNotification[] = [
  ...
  { id: 'N-3', title: 'Refund request over $62', detail: 'REF-3311 · $79· FitZone Sports', at: '2 hours ago', kind: 'refund', unread: true },
  { id: 'N-4', title: 'Settlement batch ready', detail: '2 settlements eligible · $1,600total', at: '5 hours ago', kind: 'settlement', unread: false },
