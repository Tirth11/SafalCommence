...
export const SHIPPING_OPTIONS = [
  { id: 'standard', label: 'Standard Delivery', price: 50, estimate: '3–5 business days' },
  { id: 'express', label: 'Express Delivery', price: 150, estimate: '1–2 business days' },
]
    ...
    shipments: [
      {
        ...
        items: [{ productId: 'SH-P-1042', name: 'Wireless Noise Cancelling Headphones', variant: 'Black', qty: 1, price: 4999, glyph: 'headphones', tone: 'brand' }],
      },
      {
        id: 'SHP-2',
        seller: 'TravelGear Store',
        ...
        items: [{ productId: 'SH-P-1056', name: 'Canvas Travel Backpack 30L', variant: 'Olive', qty: 1, price: 2499, glyph: 'bag', tone: 'teal' }],
      },
    ],
  },
  {
    ...
    shipments: [
      {
        ...
        items: [{ productId: 'SH-P-1044', name: 'Titanium Smartwatch — Series 4', variant: '46 mm · Titanium', qty: 1, price: 9499, glyph: 'watch', tone: 'ink' }],
      },
    ],
  },
  {
    ...
    shipments: [
      {
        ...
        items: [{ productId: 'SH-P-1048', name: 'Ceramic Table Lamp with Linen Shade', variant: 'Sand', qty: 1, price: 2449, glyph: 'lamp', tone: 'gold' }],
      },
    ],
  },
  {
    ...
    shipments: [
      {
        ...
        items: [{ productId: 'SH-P-1052', name: 'Adjustable Dumbbell Set — 20 kg', variant: '20 kg', qty: 1, price: 6299, glyph: 'dumbbell', tone: 'ink' }],
      },
    ],
  },
  {
    ...
    shipments: [
      {
        ...
        items: [{ productId: 'SH-P-1054', name: 'USB-C 65W GaN Charger', variant: 'White', qty: 1, price: 1899, glyph: 'bottle', tone: 'gold' }],
      },
    ],
  },
]
...
export const CUSTOMER_NOTIFICATIONS: CustomerNotification[] = [
  ...
  { id: 'CN-4', kind: 'payment', title: 'Refund completed', detail: '₹1,139 refunded to UPI · Google Pay', at: '04 Aug 2026', unread: false, to: '/account/returns' },
